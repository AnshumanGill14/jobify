...
import { Header, JobCard, ListBox, Loading } from '../components';
import { BiBriefcase, BiBriefcaseAlt2 } from 'react-icons/bi';
...
<div className='container mx-auto flex gap-6 2xl:gap-10 md:px-5 py-0 md:py-6 bg-[#f7fdfd]'>
      <div className='hidden md:flex flex-col w-1/6 h-fit bg-white shadow-sm px-2'>
      ...
      <div className='w-full md:w-6/6 px-5 md:px-2'>
