    ...
    return (
        <div className={`flex w-full md:w-1/3 items-center ${styles}`}>
            ...
            <AiOutlineCloseCircle
                className='hidden md:flex text-grey-600 text-xl cursor-pointer'
                onClick={clearInput}
                />
        </div>
            ...
            <div className='w-full z-10'>
              ...
              <div className='w-full flex items-center justify-around bg-white px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
                <SearchInput 
                    ...
                    icon={<AiOutlineSearch className='text-grey-600 text-xl'/>}
                    value={searchQuery}
                ...
                <SearchInput 
                    ...
                    icon={<CiLocationOn className='text-grey-600 text-xl'/>}
                    value={location}
