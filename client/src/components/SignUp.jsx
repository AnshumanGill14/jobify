              ...
              <Dialog.Title
                  ...
                  <form 
                    ...
                    <TextInput
                      ...
                      {isRegister && (
                        <div className='w-full flex gap-1 md:gp-2'>
                        ...
                        type='text'
                        register={register(accountType==="seeker"?"firstName":"name",{required:accountType==="seeker"?"First Name is Required!":"Company Name is Required!"})}
